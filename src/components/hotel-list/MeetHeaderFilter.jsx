      ...
      <div className="row y-gap-10 items-center justify-between right-title-hotel">
        <div className="col-auto">
          <div className="text-14 pt-2">
            <span className="fw-500">25 filters result for Copenhagen,</span>  15 June,1 conference Room
            <h5>Wi-Fi included</h5>
          </div>
        </div>
        {/* End .col */}
...
export default MeetHeaderFilter;
