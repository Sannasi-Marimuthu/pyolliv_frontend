  ...
  return (
    <div className="searchMenu-guests px-20  lg:py-20 lg:px-0 js-form-dd  position-relative">
      <div
        ...
        data-bs-offset="0,22"
      >
        <span className="badge rounded-pill guest-badge" >
                Guests & Romms*
                    </span>
        <div
          className="text-15 text-light-1 ls-2 lh-16 list-guest guest-input"
...
export default GuestSearchHome;
